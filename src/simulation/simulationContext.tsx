...
const defaultPolicies: FirewallPolicy[] = [
  { id: 1, name: "LAN-to-Internet", srcintf: "port3", dstintf: "port1", srcaddr: "LAN_SUBNET", dstaddr: "all", service: "ALL", action: "accept", nat: true, logTraffic: true, schedule: "always", status: "enabled", utmProfiles: { av: "default", ips: "default", webFilter: "default", appControl: "default", dnsFilter: "default", fileFilter: "none", emailFilter: "none", dlp: "none", voip: "none", icap: "none", sslInspection: "certificate-inspection" }, hitCount: 245000 },
  { id: 2, name: "DMZ-Web-Server", srcintf: "port1", dstintf: "port4", srcaddr: "all", dstaddr: "DMZ_SERVERS", service: "HTTP HTTPS", action: "accept", nat: false, logTraffic: true, schedule: "always", status: "enabled", utmProfiles: { av: "high-security", ips: "protect_http_server", webFilter: "none", appControl: "none", dnsFilter: "none", fileFilter: "none", emailFilter: "none", dlp: "none", voip: "none", icap: "none", sslInspection: "deep-inspection" }, hitCount: 189000 },
  { id: 3, name: "DNS-Allow", srcintf: "port3", dstintf: "port1", srcaddr: "LAN_SUBNET", dstaddr: "DNS_SERVERS", service: "DNS", action: "accept", nat: true, logTraffic: false, schedule: "always", status: "enabled", utmProfiles: { av: "none", ips: "default", webFilter: "none", appControl: "none", dnsFilter: "default", fileFilter: "none", emailFilter: "none", dlp: "none", voip: "none", icap: "none", sslInspection: "none" }, hitCount: 98000 },
  { id: 4, name: "Block-Gambling", srcintf: "port3", dstintf: "port1", srcaddr: "LAN_SUBNET", dstaddr: "BLOCKED_SITES", service: "ALL", action: "deny", nat: false, logTraffic: true, schedule: "always", status: "enabled", utmProfiles: { av: "none", ips: "none", webFilter: "strict", appControl: "none", dnsFilter: "none", fileFilter: "none", emailFilter: "none", dlp: "none", voip: "none", icap: "none", sslInspection: "none" }, hitCount: 12000 },
  { id: 5, name: "VPN-Users-Access", srcintf: "ssl.root", dstintf: "port3", srcaddr: "VPN_USERS", dstaddr: "LAN_SUBNET", service: "ALL", action: "accept", nat: false, logTraffic: true, schedule: "always", status: "enabled", utmProfiles: { av: "default", ips: "default", webFilter: "default", appControl: "default", dnsFilter: "default", fileFilter: "none", emailFilter: "none", dlp: "none", voip: "none", icap: "none", sslInspection: "certificate-inspection" }, hitCount: 134000 },
  { id: 6, name: "Guest-WiFi-Internet", srcintf: "port3", dstintf: "port1", srcaddr: "GUEST_WIFI", dstaddr: "all", service: "HTTP HTTPS DNS", action: "accept", nat: true, logTraffic: true, schedule: "business-hours", status: "enabled", utmProfiles: { av: "default", ips: "default", webFilter: "strict", appControl: "monitor-only", dnsFilter: "default", fileFilter: "none", emailFilter: "none", dlp: "none", voip: "none", icap: "none", sslInspection: "certificate-inspection" }, hitCount: 78000 },
  { id: 7, name: "Block-All-Default", srcintf: "any", dstintf: "any", srcaddr: "all", dstaddr: "all", service: "ALL", action: "deny", nat: false, logTraffic: true, schedule: "always", status: "enabled", utmProfiles: { av: "none", ips: "none", webFilter: "none", appControl: "none", dnsFilter: "none", fileFilter: "none", emailFilter: "none", dlp: "none", voip: "none", icap: "none", sslInspection: "none" }, hitCount: 567000 },
];
