...
import { GraduationCap, Clock, Target, ChevronRight } from "lucide-react";
      ...
      <div className="space-y-6">
        ...
        <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
          {filtered.map(scenario => {
            ...
            return (
              <Card key={scenario.id} className="hover:border-primary/50 transition-colors cursor-pointer group" onClick={() => navigate(`/training/lab/${scenario.id}`)}>
